...
export const DEF_CATS: Category[] = [
  { id: "cat-hom", name: "Housing", kind: "expense", color: "#B98DA8", emoji: "🏠", need: "need" },
  { id: "cat-fd", name: "Food", kind: "expense", color: "#C98A5E", emoji: "🍽️", need: "need" },
  { id: "cat-gro", name: "Groceries", kind: "expense", color: "#7C9AA6", emoji: "🛒", need: "need" },
  { id: "cat-utl", name: "Utilities", kind: "expense", color: "#8FA6C9", emoji: "💡", need: "need" },
  { id: "cat-tra", name: "Transportation", kind: "expense", color: "#A68A7C", emoji: "🚗", need: "need" },
  { id: "cat-shp", name: "Shopping", kind: "expense", color: "#C99A7C", emoji: "🛍️", need: "want" },
  { id: "cat-cth", name: "Clothes", kind: "expense", color: "#A68393", emoji: "👕", need: "want" },
  { id: "cat-gout", name: "Going out", kind: "expense", color: "#C98B8B", emoji: "🍻", need: "want" },
  { id: "cat-ent", name: "Entertainment", kind: "expense", color: "#9B8CA6", emoji: "🍿", need: "want" },
  { id: "cat-sub", name: "Subscription", kind: "expense", color: "#8CA6A3", emoji: "📅", need: "want" },
  { id: "cat-ext", name: "Extras", kind: "expense", color: "#777B7E", emoji: "🤷🏻‍♂️", need: "want" },
  { id: "cat-sav", name: "Savings", kind: "expense", color: "#5BB98C", emoji: "🎯", need: "saving" },
